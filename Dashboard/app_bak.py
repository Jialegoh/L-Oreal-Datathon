...
# Optional heavy libs are imported lazily where used
...
tab1, tab2, tab3, tab4, tab5, tab6 = st.tabs(["Overview", "Sentiment", "Trends", "WordCloud", "AI Model Predictions", "Classification Model"])
